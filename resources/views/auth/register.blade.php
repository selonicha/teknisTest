...
<body>
    <div class="login">
        <form action="authRegister" method="post" class="login-form">
            ...
            <div class="mb-3">
                <input type="name" class="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="name...">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="password" class="form-control" id="confirm-password" aria-describedby="passwordHelp" name="password" placeholder="confirm-password...">
            </div>
            <div class="help">
                <h6 class="fw-light">Have account? <span class="fw-semibold">
